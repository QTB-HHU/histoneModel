...
set origin 0.0,0.0;  plot [0:60000] [] "netflux.dat" u 1:2 w l title "dM/dt=f1-f2";
set origin 0.0,0.33;  plot [0:60000] [] "netflux.dat" u 1:3 w l title "dH/dt=f3-f4-f6"; 
set origin 0.0,0.66;  plot [0:60000] [] "netflux.dat" u 1:4 w l title "dD/dt=f5-f6"; 
