...
//   original name:   DNAcf_H2Ben_pl_H3_v5exp_Sondemand.c
...
//  parameter to controll SLBP S
 ...
 // S6=50000;  //   unit s  -  decay phase, time depenendent
...
// printf("seed %ld\n",dd);
printf("\n 3gene histone feedback loop model, normal S-phase\n");
printf("initial conditions: endog. H2B histon protein=%.2lf, plasmid H2B histon protein=%.2lf, endog. H3 histon protein=%.2lf, endog. H2B histon mRNA=%.2lf, plasmid H2B histon mRNA=%.2lf, endog. H3 histon mRNA=%.2lf, histone binding sites (DNA)=%.2lf, total new DNA=%.2lf with endog. H2B, total new DNA=%.2lf with plasmid H2B,\n",He2bold,Hp2bold,He3old,Me2bold,Mp2bold,Me3old,Dold,totnDNAe,totnDNAp);
 ...
 printf("not integral, only for control\n");
 printf("endogenous H2B protein built-in DNA after one S-phase totnDNAe=%lf\n",totnDNAe);
 printf("plasmid H2B protein built-in DNA after one S-phase totnDNAp=%lf\n",totnDNAp);
 printf("endogenous H3 protein built-in DNA after one S-phase totnDNAe+totnDNAp=%lf\n\n",totnDNAe+totnDNAp);
